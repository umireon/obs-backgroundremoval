...
ExternalProject_Add(
  ...
  CONFIGURE_COMMAND ""
  BUILD_COMMAND
    ${Python3_EXECUTABLE} <SOURCE_DIR>/tools/ci_build/build.py --build_dir <BINARY_DIR>
...
if(OS_WINDOWS)  
  ...
  target_link_libraries(Onnxruntime INTERFACE Onnxruntime::DirectML d3d12.lib dxgi.lib)
endif()
